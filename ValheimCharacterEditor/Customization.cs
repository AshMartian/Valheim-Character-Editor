...
namespace ValheimCharacterEditor
{
    class Customization
    {
        ...
        static public Boolean SelectedCharacterFemale;
        ...
        static private Byte[] _Gender = { 0x00, 0x01 };
        ...
        static public bool ReadCustomization()
        {
            ...
            // Get Gender
            // Gender +24 bytes after hair color, 00 for male, 01 for female

            gender = data[_CurrentCharacterHairColorPosition + 24];
            SelectedCharacterFemale = gender.Equals(_Gender[1]);
        ...
        static private bool _WriteCustomization(String Beard_UI, String Hair_UI, String HairColor_UI, Boolean Gender_Female)
        {
            ...
            byte Gender = Gender_Female ? _Gender[1] : _Gender[0];
            ...
            // Write gender
            data[_CurrentCharacterHairColorPosition + 24] = Gender;
        ...
        static public bool WriteCustomization (String Beard_UI, String Hair_UI, String HairColor_UI, Boolean Gender_Female, String Name = null)
        {
            ...
            if (_WriteName(Name) && _WriteCustomization(Beard_UI, Hair_UI, HairColor_UI, Gender_Female))
                return true;
            else
                return false;
        }
